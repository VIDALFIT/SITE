      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center">
          ...
          <p className="mt-4 max-w-2xl mx-auto text-lg text-gray-400">
            Des fonctionnalités puissantes pour t’aider à atteindre tes objectifs.
          </p>
        </div>
          ...
          <div className="grid grid-cols-1 gap-12 sm:grid-cols-2 lg:grid-cols-3">
            {features.map((feature) => (
              ...
              >
                ...
                <div className="relative p-8 rounded-2xl bg-white/5 border border-white/10 hover:border-brand-primary/50 transition-colors duration-300">
